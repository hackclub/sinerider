    ...
    function drawLocal() {
        ...
        if (deltaFOV > 0.01) {
            for (i = 0; i < Math.random(); i+=density/deltaFOV)
                particles.push([Math.random()*deltaFOV+ camera.upperRight.x,Math.random()*(camera.upperRight.y-camera.lowerLeft.y) + camera.lowerLeft.y, Math.random()])
            for (i = 0; i < Math.random(); i+=density/deltaFOV)
                particles.push([-Math.random()*deltaFOV+ camera.lowerLeft.x,Math.random()*(camera.upperRight.y-camera.lowerLeft.y) + camera.lowerLeft.y, Math.random()])
            for (i = 0; i < Math.random(); i+=(density/deltaFOV)*(5-velocityY))
            ...
            for (i = 0; i < Math.random(); i+=density/deltaFOV)
                particles.push([Math.random()*(camera.upperRight.x-camera.lowerLeft.x+3) + camera.lowerLeft.x-3,Math.random()*deltaFOV + camera.upperRight.y, Math.random()])
        }
