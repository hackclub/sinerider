  ...
  assets: {
    ...
    sounds: {
      music: {
        ...
        credits: ['.ogg', '.mp3'],
        map: ['.ogg', '.mp3'],
        western_slopes_puzzle: ['.ogg', '.mp3'],
        valley_parabola_puzzle: ['.ogg', '.mp3'],
        eternal_canyon_puzzle: ['.ogg', '.mp3'],
        sinusoidal_desert_puzzle: ['.ogg', '.mp3'],
        logistic_dunes_puzzle: ['.ogg', '.mp3'],
        hilbert_delta_puzzle: ['.ogg', '.mp3'],
        constant_lake: {
          base: ['.ogg', 'base_compressed.mp3'],
          pad_1_loopable: ['.ogg','pad_1_loopable_compressed.mp3'],
          pad_2_loopable: ['.ogg', 'pad_2_loopable_compressed.mp3'],
          pad_3_loopable: ['.ogg', 'pad_3_loopable_compressed.mp3'],
          pad_swell_1: ['.ogg', 'pad_swell_1_compressed.mp3'],
          wind: ['.ogg', 'wind_compressed.mp3'],
        },
        volcano: {
          start: ['.ogg', '.mp3'],
          middle_buildup: ['.ogg', '.mp3'],
          jump: ['.ogg', '.mp3'],
          middle_guitar: ['.ogg', 'middle_guitar.mp3'],
        },
        desert: {
          western_intro: ['.ogg', '.mp3'],
          western_loop: ['.ogg', '.mp3'],
        },
      },
      lava_monster_roar: ['.ogg', '.mp3'],
      map_button: ['.ogg', 'map_button_compressed.mp3'],
      next_button: ['.ogg', 'next_button_compressed.mp3'],
      enter_level: ['.ogg', 'enter_level_compressed.mp3'],
      goal_fail: {
        src: 'goal_fail_compressed.mp3',
        volume: 0.1,
      },
      goal_success: ['.ogg', 'goal_success_compressed.mp3'],
      level_success: ['.ogg', 'level_success_compressed.mp3'],
      restart_button: ['.ogg', 'restart_button_compressed.mp3'],
      start_running: ['.ogg', 'start_running_compressed.mp3'],
      stop_running: ['.ogg', 'stop_running_compressed.mp3'],
      map_zoom_in: {
        src: 'woosh_out.mp3',
        rate: 1.2,
      },
      ...
      path_goal_start: ['.ogg', 'path_goal_start_compressed.mp3'],
      path_goal_continue: ['.ogg', 'path_goal_continue_compressed.mp3'],
    },
    shaders: {
