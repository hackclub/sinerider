  ...
  assets: {
    ...
    sounds: {
      music: {
        ...
        credits: '.ogg',
        map: '.ogg',
        western_slopes_puzzle: '.ogg',
        valley_parabola_puzzle: '.ogg',
        eternal_canyon_puzzle: '.ogg',
        sinusoidal_desert_puzzle: '.ogg',
        logistic_dunes_puzzle: '.ogg',
        hilbert_delta_puzzle: '.ogg',
        constant_lake: {
          base: 'base_compressed.ogg',
          pad_1_loopable: 'pad_1_loopable_compressed.ogg',
          pad_2_loopable: 'pad_2_loopable_compressed.ogg',
          pad_3_loopable: 'pad_3_loopable_compressed.ogg',
          pad_swell_1: 'pad_swell_1_compressed.ogg',
          pad_swell_2: 'pad_swell_2_compressed.ogg',
          pad_swell_3: 'pad_swell_3_compressed.ogg',
          swell_1: 'swell_1_compressed.ogg',
          swell_2: 'swell_2_compressed.ogg',
          swell_3: 'swell_3_compressed.ogg',
          wind: 'wind_compressed.ogg',
        },
        volcano: {
          start: '.ogg',
          middle_buildup: '.ogg',
          jump: '.ogg',
          middle_guitar: 'middle_guitar.ogg',
        },
        desert: {
          western_intro: '.ogg',
          western_loop: '.ogg',
      ...
      lava_monster_roar: '.ogg',
      map_button: 'map_button_compressed.ogg',
      next_button: 'next_button_compressed.ogg',
      enter_level: 'enter_level_compressed.ogg',
      goal_fail: {
        src: 'goal_fail_compressed.ogg',
        volume: 0.1,
      },
      goal_success: 'goal_success_compressed.ogg',
      level_success: 'level_success_compressed.ogg',
      restart_button: 'restart_button_compressed.ogg',
      start_running: 'start_running_compressed.ogg',
      stop_running: 'stop_running_compressed.ogg',
      map_zoom_in: {
        src: 'woosh_out.ogg',
        rate: 1.2,
      },
      ...
      path_goal_start: 'path_goal_start_compressed.ogg',
      path_goal_continue: 'path_goal_continue_compressed.ogg',
    },
    shaders: {
